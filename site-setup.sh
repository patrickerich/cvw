...
if [ -z "$LD_LIBRARY_PATH" ]; then
    ...
    export LD_LIBRARY_PATH=$RISCV/riscv64-unknown-elf/lib:$LD_LIBRARY_PATH
fi

# RISC-V Tools
export LD_LIBRARY_PATH=$RISCV/lib:$RISCV/lib64:$RISCV/lib/x86_64-linux-gnu:$LD_LIBRARY_PATH
